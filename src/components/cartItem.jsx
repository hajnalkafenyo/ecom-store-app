...
export function CartItem({ id, price, discountedPrice, title, image, description }) {
        ...
        <div className="flex flex-row items-center border border-gray-300 rounded-md p-2 m-2 w-full bg-gray-50">
            ...
            <div className="flex flex-row p-2 grow">
                <div className="flex-col grow">
                    ...
                    <div className="font-light text-sm border-y border-gray-300 text-gray-600">{description}</div>
                </div>
